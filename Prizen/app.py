import cv2 # termasuk LBPH, CascadeClassifier, dsb
import os
...
def tambah_user():
    ...
    while 1:
        ...
        for (x,y,w,h) in faces:
            ...
            cv2.putText(frame,f'Images Captured: {i}/10',(x+6,y-6),cv2.FONT_HERSHEY_COMPLEX_SMALL,0.7,(255, 255, 255),1,cv2.LINE_AA)
            if j%10==0:
